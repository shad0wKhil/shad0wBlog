     ...
     <section id="blog" class="py-12 m-auto bg-gradient-to-r from-yellow-700 via-yellow-500 to-yellow-700">
                    ...
                    <div class="bg-white hover:shadow-xl">
                        <div class="">
                            <img src="https://images.pexels.com/photos/956999/milky-way-starry-sky-night-sky-star-956999.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt=""
                                class="h-56 w-full border-0 hover:opacity-70">
                        </div>
                        <div class="px-4 py-4 md:px-10">
                            ...
                            <div class="flex flex-wrap pt-8">
                                <div class="w-full md:w-1/3 text-sm font-medium text-black">
                                    NOVEMBER 1,2019
                                </div>
                                <div class="2/3">
                                    <div class="text-sm font-medium text-black">
                                        SHARE:
                                        <a href="" class="text-indigo-900 px-1 ">
                                            FACEBOOk
                                        </a>
                                        <a href="" class="text-blue-500 px-1 ">
                                            TWITTER
                                        </a>
                                        <a href="" class="text-red-900 px-1 ">
                                            GOOGLE+
                                        </a>
                                    </div>
                                </div>
